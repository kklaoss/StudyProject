...
int main() // Главная функция программы
{
	...
	cout << "Содержимое очереди после добавления чисел 2.1, 2.1, 5.3: "; // Вывод сообщения
	print_queue(queue); // Вывод содержимого очереди
	dequeue(queue); // Удаление одного элемента из очереди
	cout << "Содержимое очереди после удаления одного элемента: "; // Вывод сообщения
	print_queue(queue); // Вывод содержимого очереди
	enqueue(queue, 4.9); // Добавление числа 4.9 в очередь
	cout << "Содержимое очереди после добавления числа 4.9: "; // Вывод сообщения
	print_queue(queue); // Вывод содержимого очереди
	double sum = sum_queue(queue); // Вычисление суммы элементов очереди
	cout << "Сумма элементов очереди: " << sum << endl; // Вывод суммы элементов очереди
}